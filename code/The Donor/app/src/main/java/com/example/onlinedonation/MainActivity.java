...
public class MainActivity extends AppCompatActivity {
    ...
    private Button donateItem2; private Button donateItem3;
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId())
        {
            ...
            case  R.id.showStatistics:
                ...
                break;
            case  R.id.ngoConfirmation:
                Intent intent2 = new Intent(MainActivity.this,DonorPendingActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        img_History = findViewById(R.id.history);
        ...
        btn_addItem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                donateItem2 = customView.findViewById(R.id.fragmentAddBtnBook);

                donateItem3 = customView.findViewById(R.id.fragmentAddBtnClothes);
                ...
                donateItem2.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        popupWindow.dismiss();
                        getSupportFragmentManager().beginTransaction().replace(R.id.frame_layout, new DonateItemFragment()).commit();
                ...
                donateItem3.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        popupWindow.dismiss();
                        getSupportFragmentManager().beginTransaction().replace(R.id.frame_layout, new DonateItemFragment()).commit();
